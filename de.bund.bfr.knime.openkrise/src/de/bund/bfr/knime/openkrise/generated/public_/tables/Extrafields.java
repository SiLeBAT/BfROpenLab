...
public class Extrafields extends TableImpl<ExtrafieldsRecord> {
	...
	private static final long serialVersionUID = -1112829136;
	 ...
	 */
	public final TableField<ExtrafieldsRecord, String> TABLENAME = createField("tablename",
	 ...
	 */
	public final TableField<ExtrafieldsRecord, String> ATTRIBUTE = createField("attribute",
			org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

	/**
	 * The column <code>PUBLIC.ExtraFields.value</code>.
	 */
	public final TableField<ExtrafieldsRecord, String> VALUE = createField("value",
			org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");
