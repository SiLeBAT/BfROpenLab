...
public class Chargenverbindungen extends TableImpl<ChargenverbindungenRecord> {
	...
	private static final long serialVersionUID = -2037566834;
	 ...
	 */
	public final TableField<ChargenverbindungenRecord, Integer> ID = createField("ID",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>PUBLIC.ChargenVerbindungen.Zutat</code>.
	 */
	public final TableField<ChargenverbindungenRecord, Integer> ZUTAT = createField("Zutat",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.ChargenVerbindungen.Produkt</code>.
	 */
	public final TableField<ChargenverbindungenRecord, Integer> PRODUKT = createField("Produkt",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.ChargenVerbindungen.MixtureRatio</code>.
	 */
	public final TableField<ChargenverbindungenRecord, Double> MIXTURERATIO = createField("MixtureRatio",
			org.jooq.impl.SQLDataType.DOUBLE, this, "");

	/**
	 * The column <code>PUBLIC.ChargenVerbindungen.ImportSources</code>.
	 */
	public final TableField<ChargenverbindungenRecord, String> IMPORTSOURCES = createField("ImportSources",
			org.jooq.impl.SQLDataType.VARCHAR.length(16383), this, "");

	/**
	 * The column <code>PUBLIC.ChargenVerbindungen.Kommentar</code>.
	 */
	public final TableField<ChargenverbindungenRecord, String> KOMMENTAR = createField("Kommentar",
	...
	public List<ForeignKey<ChargenverbindungenRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<ChargenverbindungenRecord, ?>> asList(Keys.CHARGENVERBINDUNGEN_FK_ZUTAT_0,
				Keys.CHARGENVERBINDUNGEN_FK_PRODUKT_1);
	}
