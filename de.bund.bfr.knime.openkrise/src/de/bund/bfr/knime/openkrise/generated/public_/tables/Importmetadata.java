...
public class Importmetadata extends TableImpl<ImportmetadataRecord> {
	...
	private static final long serialVersionUID = 706522247;
	 ...
	 */
	public final TableField<ImportmetadataRecord, Integer> ID = createField("ID",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>PUBLIC.ImportMetadata.filename</code>.
	 */
	public final TableField<ImportmetadataRecord, String> FILENAME = createField("filename",
			org.jooq.impl.SQLDataType.VARCHAR.length(2048), this, "");

	/**
	 * The column <code>PUBLIC.ImportMetadata.reporter</code>.
	 */
	public final TableField<ImportmetadataRecord, String> REPORTER = createField("reporter",
			org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

	/**
	 * The column <code>PUBLIC.ImportMetadata.date</code>.
	 */
	public final TableField<ImportmetadataRecord, String> DATE = createField("date",
			org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

	/**
	 * The column <code>PUBLIC.ImportMetadata.remarks</code>.
	 */
	public final TableField<ImportmetadataRecord, String> REMARKS = createField("remarks",
			org.jooq.impl.SQLDataType.VARCHAR.length(2048), this, "");
