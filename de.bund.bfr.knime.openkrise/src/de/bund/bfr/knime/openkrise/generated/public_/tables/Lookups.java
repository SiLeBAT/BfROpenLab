...
public class Lookups extends TableImpl<LookupsRecord> {
	...
	private static final long serialVersionUID = 1614009199;
	 ...
	 */
	public final TableField<LookupsRecord, Integer> ID = createField("ID",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>PUBLIC.LookUps.type</code>.
	 */
	public final TableField<LookupsRecord, String> TYPE = createField("type",
			org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

	/**
	 * The column <code>PUBLIC.LookUps.value</code>.
	 */
	public final TableField<LookupsRecord, String> VALUE = createField("value",
			org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");
