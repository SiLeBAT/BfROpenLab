...
public class Lieferungen extends TableImpl<LieferungenRecord> {
	...
	private static final long serialVersionUID = -276219311;
	 ...
	 */
	public final TableField<LieferungenRecord, Integer> ID = createField("ID",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.Charge</code>.
	 */
	public final TableField<LieferungenRecord, Integer> CHARGE = createField("Charge",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.dd_day</code>.
	 */
	public final TableField<LieferungenRecord, Integer> DD_DAY = createField("dd_day",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.dd_month</code>.
	 */
	public final TableField<LieferungenRecord, Integer> DD_MONTH = createField("dd_month",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.dd_year</code>.
	 */
	public final TableField<LieferungenRecord, Integer> DD_YEAR = createField("dd_year",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.ad_day</code>.
	 */
	public final TableField<LieferungenRecord, Integer> AD_DAY = createField("ad_day",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.ad_month</code>.
	 */
	public final TableField<LieferungenRecord, Integer> AD_MONTH = createField("ad_month",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.ad_year</code>.
	 */
	public final TableField<LieferungenRecord, Integer> AD_YEAR = createField("ad_year",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.numPU</code>.
	 */
	public final TableField<LieferungenRecord, Double> NUMPU = createField("numPU", org.jooq.impl.SQLDataType.DOUBLE,
			this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.typePU</code>.
	 */
	public final TableField<LieferungenRecord, String> TYPEPU = createField("typePU",
			org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.Unitmenge</code>.
	 */
	public final TableField<LieferungenRecord, Double> UNITMENGE = createField("Unitmenge",
			org.jooq.impl.SQLDataType.DOUBLE, this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.UnitEinheit</code>.
	 */
	public final TableField<LieferungenRecord, String> UNITEINHEIT = createField("UnitEinheit",
			org.jooq.impl.SQLDataType.VARCHAR.length(50), this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.Empfänger</code>.
	 */
	public final TableField<LieferungenRecord, Integer> EMPFÄNGER = createField("Empfänger",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.Serial</code>.
	 */
	public final TableField<LieferungenRecord, String> SERIAL = createField("Serial",
			org.jooq.impl.SQLDataType.VARCHAR.length(16383), this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.EndChain</code>.
	 */
	public final TableField<LieferungenRecord, String> ENDCHAIN = createField("EndChain",
			org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.Explanation_EndChain</code>.
	 */
	public final TableField<LieferungenRecord, String> EXPLANATION_ENDCHAIN = createField("Explanation_EndChain",
			org.jooq.impl.SQLDataType.VARCHAR.length(16383), this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.Contact_Questions_Remarks</code>.
	 */
	public final TableField<LieferungenRecord, String> CONTACT_QUESTIONS_REMARKS = createField(
			"Contact_Questions_Remarks", org.jooq.impl.SQLDataType.VARCHAR.length(16383), this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.Further_Traceback</code>.
	 */
	public final TableField<LieferungenRecord, String> FURTHER_TRACEBACK = createField("Further_Traceback",
			org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.ImportSources</code>.
	 */
	public final TableField<LieferungenRecord, String> IMPORTSOURCES = createField("ImportSources",
			org.jooq.impl.SQLDataType.VARCHAR.length(16383), this, "");

	/**
	 * The column <code>PUBLIC.Lieferungen.Kommentar</code>.
	 */
	public final TableField<LieferungenRecord, String> KOMMENTAR = createField("Kommentar",
	...
	public List<ForeignKey<LieferungenRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<LieferungenRecord, ?>> asList(Keys.LIEFERUNGEN_FK_CHARGE_0,
				Keys.LIEFERUNGEN_FK_EMPFÄNGER_8);
	}
