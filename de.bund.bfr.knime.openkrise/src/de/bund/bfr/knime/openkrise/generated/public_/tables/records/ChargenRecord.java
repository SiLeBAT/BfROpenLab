...
public class ChargenRecord extends UpdatableRecordImpl<ChargenRecord>implements
		Record18<Integer, Integer, Integer, String, Double, String, Integer, Integer, Integer, Integer, Integer, Integer, Integer, String, String, String, String, String> {

	private static final long serialVersionUID = -1316302924;
	 ...
	 */
	@Override
	public ChargenRecord values(Integer value1, Integer value2, Integer value3, String value4, Double value5,
			String value6, Integer value7, Integer value8, Integer value9, Integer value10, Integer value11,
			Integer value12, Integer value13, String value14, String value15, String value16, String value17,
			String value18) {
		value1(value1);
		value2(value2);
		value3(value3);
	 ...
	 */
	public ChargenRecord(Integer id, Integer artikel, Integer zutaten, String chargennr, Double menge, String einheit,
			Integer lieferungen, Integer mhdDay, Integer mhdMonth, Integer mhdYear, Integer pdDay, Integer pdMonth,
			Integer pdYear, String serial, String origincountry, String microbiosample, String importsources,
			String kommentar) {
		super(Chargen.CHARGEN);
