...
public class Chargen extends TableImpl<ChargenRecord> {
	...
	private static final long serialVersionUID = 1697349245;
	 ...
	 */
	public final TableField<ChargenRecord, Integer> ID = createField("ID",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>PUBLIC.Chargen.Artikel</code>.
	 */
	public final TableField<ChargenRecord, Integer> ARTIKEL = createField("Artikel", org.jooq.impl.SQLDataType.INTEGER,
			this, "");

	/**
	 * The column <code>PUBLIC.Chargen.Zutaten</code>.
	 */
	public final TableField<ChargenRecord, Integer> ZUTATEN = createField("Zutaten", org.jooq.impl.SQLDataType.INTEGER,
			this, "");

	/**
	 * The column <code>PUBLIC.Chargen.ChargenNr</code>.
	 */
	public final TableField<ChargenRecord, String> CHARGENNR = createField("ChargenNr",
	 ...
	 */
	public final TableField<ChargenRecord, String> EINHEIT = createField("Einheit",
			org.jooq.impl.SQLDataType.VARCHAR.length(50), this, "");

	/**
	 * The column <code>PUBLIC.Chargen.Lieferungen</code>.
	 */
	public final TableField<ChargenRecord, Integer> LIEFERUNGEN = createField("Lieferungen",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Chargen.MHD_day</code>.
	 */
	public final TableField<ChargenRecord, Integer> MHD_DAY = createField("MHD_day", org.jooq.impl.SQLDataType.INTEGER,
			this, "");

	/**
	 * The column <code>PUBLIC.Chargen.MHD_month</code>.
	 */
	public final TableField<ChargenRecord, Integer> MHD_MONTH = createField("MHD_month",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Chargen.MHD_year</code>.
	 */
	public final TableField<ChargenRecord, Integer> MHD_YEAR = createField("MHD_year",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Chargen.pd_day</code>.
	 */
	public final TableField<ChargenRecord, Integer> PD_DAY = createField("pd_day", org.jooq.impl.SQLDataType.INTEGER,
			this, "");

	/**
	 * The column <code>PUBLIC.Chargen.pd_month</code>.
	 */
	public final TableField<ChargenRecord, Integer> PD_MONTH = createField("pd_month",
			org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>PUBLIC.Chargen.pd_year</code>.
	 */
	public final TableField<ChargenRecord, Integer> PD_YEAR = createField("pd_year", org.jooq.impl.SQLDataType.INTEGER,
			this, "");

	/**
	 * The column <code>PUBLIC.Chargen.Serial</code>.
	 */
	public final TableField<ChargenRecord, String> SERIAL = createField("Serial",
			org.jooq.impl.SQLDataType.VARCHAR.length(16383), this, "");

	/**
	 * The column <code>PUBLIC.Chargen.OriginCountry</code>.
	 */
	public final TableField<ChargenRecord, String> ORIGINCOUNTRY = createField("OriginCountry",
			org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

	/**
	 * The column <code>PUBLIC.Chargen.MicrobioSample</code>.
	 */
	public final TableField<ChargenRecord, String> MICROBIOSAMPLE = createField("MicrobioSample",
			org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

	/**
	 * The column <code>PUBLIC.Chargen.ImportSources</code>.
	 */
	public final TableField<ChargenRecord, String> IMPORTSOURCES = createField("ImportSources",
			org.jooq.impl.SQLDataType.VARCHAR.length(16383), this, "");

	/**
	 * The column <code>PUBLIC.Chargen.Kommentar</code>.
	 */
	public final TableField<ChargenRecord, String> KOMMENTAR = createField("Kommentar",
