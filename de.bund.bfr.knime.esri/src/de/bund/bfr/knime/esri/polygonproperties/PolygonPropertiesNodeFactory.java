 ...
 */
public class PolygonPropertiesNodeFactory extends
		NodeFactory<PolygonPropertiesNodeModel> {
	 ...
	 */
	@Override
	public NodeView<PolygonPropertiesNodeModel> createNodeView(
			final int viewIndex, final PolygonPropertiesNodeModel nodeModel) {
		return null;
	}
