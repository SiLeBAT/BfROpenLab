 ...
 * </p>
 * <ul>
 *   <li>{@link de.bund.bfr.knime.pmmlite.core.models.impl.VariableImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.bund.bfr.knime.pmmlite.core.models.impl.VariableImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends EObjectImpl implements Variable {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelsPackage.VARIABLE__NAME, oldName, name));
	}
	...
	public void setUnit(PmmUnit newUnit) {
		...
		unit = newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelsPackage.VARIABLE__UNIT, oldUnit, unit));
	}
