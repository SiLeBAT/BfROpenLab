 ...
 * </p>
 * <ul>
 *   <li>{@link de.bund.bfr.knime.pmmlite.core.models.impl.RenamingsImpl#getMap <em>Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RenamingsImpl extends EObjectImpl implements Renamings {
	/**
	...
	protected EClass eStaticClass() {
		return ModelsPackage.Literals.RENAMINGS;
	}
	...
	public EMap<String, String> getMap() {
		if (map == null) {
			map = new EcoreEMap<String,String>(ModelsPackage.Literals.STRING_TO_STRING_MAP_ENTRY, StringToStringMapEntryImpl.class, this, ModelsPackage.RENAMINGS__MAP);
		}
		return map;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelsPackage.RENAMINGS__MAP:
