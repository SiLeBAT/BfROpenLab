...
CREATE VIEW "IndepVarView" AS
    ...
    SELECT
	  "GeschaetzteModelle"."ID" AS "GeschaetztesModell",
        ...
        ARRAY_AGG("ModellkatalogParameter"."Beschreibung") AS "IndepDescription",
        ARRAY_AGG("Einheiten"."Einheit") AS "Einheiten",
        ARRAY_AGG("Gueltig_von") AS "minIndep",
        ARRAY_AGG("Gueltig_bis") AS "maxIndep",
        ARRAY_AGG("MKE"."object type") AS "IndepOT",
        ARRAY_AGG("MKE"."kind of property / quantity") AS "IndepCategory",
        ARRAY_AGG("MKE"."display in GUI as") AS "IndepUnit"
