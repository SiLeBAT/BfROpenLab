...
public class UpdateChecker {
	public static void check4Updates_185_186() {
	...
	public static void check4Updates_1820_18200() {
		...
		new GeneralXLSImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/Einheiten_141124.xls", null, false);
	}
	public static void check4Updates_182_1820() {
		new GeneralXLSImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/Einheiten_141120.xls", null, false);
	}
	...
	public static void check4Updates_176_177() {
		new GeneralXLSImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/Einheiten_140312.xls", null, false);
	...
	public static void check4Updates_174_175() {
		...
		new SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_ParamVarView_175.sql", null, false);
		new SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelPrimView_175.sql", null, false);
		new SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelSecView_175.sql", null, false);
	}
	...
	public static void check4Updates_171_172() {
		new SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelPrimView_172.sql", null, false);
		new SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelSecView_172.sql", null, false);
	}

	public static void check4Updates_170_171() {
		boolean isBios = false;
		if (isBios) {
			new GeneralXLSImporter(true).doImport("/de/bund/bfr/knime/openkrise/db/res/Einheiten_130902.xls", null, false);
			...
			new GeneralXLSImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/Einheiten_130902.xls", null, false);
		}
	}
	 ...
	 * ("/de/bund/bfr/knime/openkrise/db/res/001_ParamVarView_170.sql", null, false); new
	 * SQLScriptImporter
	 * ().doImport("/de/bund/bfr/knime/openkrise/db/res/001_IndepVarView_170.sql", null, false);
	 * new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_DepVarView_170.sql"
	 * , null, false); new SQLScriptImporter().doImport(
	 * "/de/bund/bfr/knime/openkrise/db/res/002_EstModelPrimView_170.sql", null, false); new
	 * SQLScriptImporter
	 * ().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelSecView_170.sql", null,
	 * false); } public static void check4Updates_168_169() { new
	 * GeneralXLSImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/Einheiten_130823.xls",
	 ...
	 * "/de/bund/bfr/knime/openkrise/db/res/002_EstModelPrimView_168.sql", null, false); new
	 * SQLScriptImporter
	 * ().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelSecView_168.sql", null,
	 * false); } public static void check4Updates_166_167() { new
	 * GeneralXLSImporter
	 * ().doImport("/de/bund/bfr/knime/openkrise/db/res/SonstigeParameter_167.xls", null,
	 ...
	 * 
	 * new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_ParamVarView_166.sql"
	 * , null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_IndepVarView_166.sql"
	 * , null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_DepVarView_166.sql"
	 * , null, false); new SQLScriptImporter().doImport(
	 ...
	 * 
	 * new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_ParamVarView_165.sql"
	 * , null, false); new SQLScriptImporter().doImport(
	 * "/de/bund/bfr/knime/openkrise/db/res/002_EstModelPrimView_165.sql", null, false); new
	 * SQLScriptImporter
	 * ().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelSecView_165.sql", null,
	 ...
	 * 
	 * new SQLScriptImporter().doImport(
	 * "/de/bund/bfr/knime/openkrise/db/res/03_create_messwerteeinfach_164.sql", null, false); }
	 ...
	 * 
	 * new
	 * GeneralXLSImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/Einheiten_New.xls",
	 ...
	 * 
	 * new SQLScriptImporter().doImport(
	 * "/de/bund/bfr/knime/openkrise/db/res/03_create_messwerteeinfach_163.sql", null, false); }
	 ...
	 * DBKernel.delimitL("ParamView") + ";", false); new
	 * SQLScriptImporter().doImport
	 * ("/de/bund/bfr/knime/openkrise/db/res/001_ParamVarView_162.sql", null, false); new
	 * SQLScriptImporter
	 * ().doImport("/de/bund/bfr/knime/openkrise/db/res/001_IndepVarView_162.sql", null, false);
	 * new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_DepVarView_162.sql"
	 * , null, false); new SQLScriptImporter().doImport(
	 * "/de/bund/bfr/knime/openkrise/db/res/002_EstModelPrimView_162.sql", null, false); new
	 * SQLScriptImporter
	 * ().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelSecView_162.sql", null,
	 ...
	 * "/de/bund/bfr/knime/openkrise/db/res/001_SonstigesEinfach_160.sql", null, false); }
	 ...
	 * new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_ParamVarView_159.sql"
	 * , null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_IndepVarView_159.sql"
	 * , null, false); new SQLScriptImporter().doImport(
	 * "/de/bund/bfr/knime/openkrise/db/res/002_EstModelPrimView_159.sql", null, false); new
	 * SQLScriptImporter
	 * ().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelSecView_159.sql", null,
	 ...
	 * SQLScriptImporter(
	 * ).doImport("/de/bund/bfr/knime/openkrise/db/res/04_create_versuchsbedingungeneinfach_156.sql"
	 * , null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_ParamVarView.sql",
	 * null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelPrimView.sql"
	 * , null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelSecView.sql"
	 * , null, false); } public static void check4Updates_156_157() {
	 * DBKernel.sendRequest("DROP VIEW IF EXISTS " +
	 * DBKernel.delimitL("EstModelPrimView") + ";", false);
	 * DBKernel.sendRequest("DROP VIEW IF EXISTS " +
	 * DBKernel.delimitL("EstModelSecView") + ";", false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_IndepVarView.sql",
	 * null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelPrimView.sql"
	 * , null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelSecView.sql"
	 ...
	 * SQLScriptImporter().doImport(
	 * "/de/bund/bfr/knime/openkrise/db/res/04_create_versuchsbedingungeneinfach_156.sql", null,
	 * false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelPrimView.sql"
	 * , null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelSecView.sql"
	 ...
	 * SQLScriptImporter
	 * ().doImport("/de/bund/bfr/knime/openkrise/db/res/01_sonstigeseinfach_155.sql", null,
	 * false); new SQLScriptImporter().doImport(
	 * "/de/bund/bfr/knime/openkrise/db/res/03_create_messwerteeinfach_155.sql", null, false); }
	 ...
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/CombaseRawDataImport.sql"
	 * , null, false); } public static void check4Updates_150_151() { new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_DepVarView.sql",
	 * null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_IndepVarView.sql",
	 * null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_LitEmView.sql",
	 * null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_LitMView.sql",
	 * null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_ParamVarView.sql",
	 * null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/001_VarParMapView.sql",
	 * null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelPrimView.sql"
	 * , null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/002_EstModelSecView.sql"
	 ...
	 * 
	 * new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/01_sonstigeseinfach.sql"
	 * , null, false); new SQLScriptImporter().doImport(
	 * "/de/bund/bfr/knime/openkrise/db/res/02_create_doublekennzahleneinfach.sql", null,
	 * false); new SQLScriptImporter().doImport(
	 * "/de/bund/bfr/knime/openkrise/db/res/03_create_messwerteeinfach.sql", null, false); new
	 * SQLScriptImporter
	 * ().doImport("/de/bund/bfr/knime/openkrise/db/res/04_create_versuchsbedingungeneinfach.sql"
	 * , null, false); new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/05_create_modelview.sql"
	 * , null, false); new SQLScriptImporter().doImport(
	 * "/de/bund/bfr/knime/openkrise/db/res/06_create_estmodelprimview.sql", null, false); new
	 * SQLScriptImporter
	 * ().doImport("/de/bund/bfr/knime/openkrise/db/res/07_create_estmodelsecview.sql", null,
	 * false);
	 * 
	 * } public static void check4Updates_148_149() { new
	 * SQLScriptImporter().doImport("/de/bund/bfr/knime/openkrise/db/res/create_view_set.sql",
	 ...
	 * "/de/bund/bfr/knime/openkrise/db/res/Kostenkatalog_mit_Einheiten.xls",
	 ...
	 * "/de/bund/bfr/knime/openkrise/db/res/Verpackungsmaterial.xls",
	 * DBKernel.mainFrame.getProgressBar(), false); new
	 * GeneralXLSImporter().doImport
	 * ("/de/bund/bfr/knime/openkrise/db/res/ImportedCombaseData.xls",
