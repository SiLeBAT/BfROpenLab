...
import de.bund.bfr.knime.openkrise.db.gui.simsearch.DBInfo;
...
public class UpdateChecker {
	public static void check4Updates_186_187() {
//		DBKernel.sendRequest("CREATE TABLE " + DBInfo.TABLE.IGNORESTATIONSIM.getName() + "(" +
...
//		  
//		DBKernel.sendRequest("CREATE TABLE " + DBInfo.TABLE.IGNOREPRODUCTSIM.getName() + "(" +
...
//		   
//		DBKernel.sendRequest("CREATE TABLE " + DBInfo.TABLE.IGNORELOTSIM.getName() + "(" +
...
//		  
//		DBKernel.sendRequest("CREATE TABLE " + DBInfo.TABLE.IGNOREDELIVERYSIM.getName() + "(" +
...
//		  
		...
		//CREATE TRIGGER TrigStationRemove AFTER DELETE ON DBInfo.TABLE.STATION.getName()
		
		DBKernel.sendRequest("CREATE TABLE " + DBKernel.delimitL(DBInfo.TABLE.IGNORESIM.getName()) + " (\n" +
				DBKernel.delimitL(DBInfo.COLUMN.IGNORESIM_TYPE.getName()) + " INT NOT NULL,\n" +
				DBKernel.delimitL(DBInfo.COLUMN.IGNORESIM_ID1.getName()) + " INT NOT NULL,\n" +
				DBKernel.delimitL(DBInfo.COLUMN.IGNORESIM_ID2.getName()) + " INT NOT NULL\n" +
				");", false, true);
		
		Map<DBInfo.TABLE, SimSearch.SimSet.Type> map = new HashMap<>();
		map.put(DBInfo.TABLE.STATION, SimSearch.SimSet.Type.STATION);
		map.put(DBInfo.TABLE.PRODUCT, SimSearch.SimSet.Type.PRODUCT);
		map.put(DBInfo.TABLE.LOT, SimSearch.SimSet.Type.LOT);
		map.put(DBInfo.TABLE.DELIVERY, SimSearch.SimSet.Type.DELIVERY);
		
		for(Entry<DBInfo.TABLE, SimSearch.SimSet.Type> entry: map.entrySet()) {
			DBKernel.sendRequest("CREATE TRIGGER Trigger" + entry.getKey().getName() + "Delete AFTER DELETE ON " + DBKernel.delimitL(entry.getKey().getName()) + " \n" +
					"REFERENCING OLD ROW AS oldRow FOR EACH ROW \n" +
					"BEGIN ATOMIC \n" +
					"DELETE FROM " + DBKernel.delimitL(DBInfo.TABLE.IGNORESIM.getName()) +  " WHERE " + DBKernel.delimitL(DBInfo.COLUMN.IGNORESIM_TYPE.getName()) + "=" +  entry.getValue().getValue() + " AND " +
					"(" + DBKernel.delimitL(DBInfo.COLUMN.IGNORESIM_ID1.getName()) + " = oldRow.ID OR " +  DBKernel.delimitL(DBInfo.COLUMN.IGNORESIM_ID2.getName()) + "=oldRow.ID);\n" +
					"end;", false, true);
		}
//		DBKernel.sendRequest("CREATE TRIGGER Trigger_" + DBInfo.TABLE.STATION.getName() + "_Delete AFTER DELETE ON " + DBInfo.TABLE.STATION.getName() + " \n" +
//				"REFERENCING OLD ROW AS oldRow FOR EACH ROW \n" +
//				"BEGIN ATOMIC \n" +
//				"DELETE FROM " + DBInfo.TABLE.IGNORESIM.getName() +  " WHERE " + DBInfo.COLUMN.IGNORESIM_TYPE.getName() + "=" +  SimSearch.SimSet.Type.STATION.getValue() + " AND " +
//				"(" + DBInfo.COLUMN.IGNORESIM_ID1 + " = oldRow.ID OR " +  DBInfo.COLUMN.IGNORESIM_ID2.getName() + "=oldRow.ID);\n" +
//				"end;", false, true);
//		DBKernel.sendRequest("CREATE TRIGGER Trigger_" + DBInfo.TABLE.PRODUCT.getName() + "_Delete AFTER DELETE ON " + DBInfo.TABLE.PRODUCT.getName() + " \n" +
//				"REFERENCING OLD ROW AS oldRow FOR EACH ROW \n" +
//				"BEGIN ATOMIC \n" +
//				"DELETE FROM " + DBInfo.TABLE.IGNORESIM.getName() +  " WHERE " + DBInfo.COLUMN.IGNORESIM_TYPE.getName() + "=" +  SimSearch.SimSet.Type.STATION.getValue() + " AND " +
//				"(" + DBInfo.COLUMN.IGNORESIM_ID1 + " = oldRow.ID OR " +  DBInfo.COLUMN.IGNORESIM_ID2.getName() + "=oldRow.ID);\n" +
