...
public class MyTable {
	...
	public void createTable(Connection conn) {
		...
		try {
			if (tableName.equals("ChangeLog")) {
				DBKernel.sendRequest(conn, "CREATE SEQUENCE " + DBKernel.delimitL(tableName + "SEQ") + " AS INTEGER START WITH 1 INCREMENT BY 1", false, false);
				DBKernel.sendRequest(conn, "GRANT USAGE ON SEQUENCE " + DBKernel.delimitL("ChangeLogSEQ") + " TO " + DBKernel.delimitL("PUBLIC"), false, false);
			}
