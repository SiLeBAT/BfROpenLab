...
public abstract class MultiDimensionViewModel extends ViewModel {

	protected MultiDimensionViewModel() {
		super(false);
	}
	...
	protected PortObject[] execute(PortObject[] inObjects, ExecutionContext exec) throws Exception {
		...
		String id = ((MultiDimensionViewSettings) set).getSelectedID();
