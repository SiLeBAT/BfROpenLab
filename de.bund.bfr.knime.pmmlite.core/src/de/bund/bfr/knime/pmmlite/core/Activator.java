...
public class Activator extends Plugin {
	...
	public void start(final BundleContext context) throws Exception {
		super.start(context);
		((EDataType.Internal) CommonPackage.Literals.TRANSFORM)
				.setConversionDelegate(new TransformConversionDelegate());
		((EDataType.Internal) CommonPackage.Literals.UNIT).setConversionDelegate(new PmmUnit.ConversionDelegate());
	}
